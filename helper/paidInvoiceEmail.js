    ...
    >
      ...
      <tr>
        <td
          ...
          "
        >
        You’ve successfully completed the payment for your Busy Beans Coffee order <strong>#${data.id}</strong>.  
        <br />
        You can review your order details below for your reference.
        </td>
      </tr>
      <tr>
        <td
